...
class ApplicationLuminaled:
            ...
            for attempt in range(retries):
                async with LuminaledAPI() as api:
                    try:
                        ...
                        if response:
                            data = await data_extraction_luminaled(response) 
                        else:
                            continue
    ...
    async def start(self):
        ...
        self.logger.info(r'''
         __       __    __  .___  ___.  __  .__   __.      ___       __       _______  _______  
        |  |     |  |  |  | |   \/   | |  | |  \ |  |     /   \     |  |     |   ____||       \ 
        |  |     |  |  |  | |  \  /  | |  | |   \|  |    /  ^  \    |  |     |  |__   |  .--.  |
        |  |     |  |  |  | |  |\/|  | |  | |  . `  |   /  /_\  \   |  |     |   __|  |  |  |  |
        |  `----.|  `--'  | |  |  |  | |  | |  |\   |  /  _____  \  |  `----.|  |____ |  '--'  |
        |_______| \______/  |__|  |__| |__| |__| \__| /__/     \__\ |_______||_______||_______/                                                
